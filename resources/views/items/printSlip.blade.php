        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="description">weight</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="description">{{ $row->code }}</td>
                    <td class="description">{{ $row->weight }}</td>
                    <td class=" description">{{ $row->client }}</td>
                    <td class="description">{{ $row->karat }}</td>
                    <td class="description">{{ $row->purity }}</td>
                    <td class="description">{{ $row->production_date }}</td>
