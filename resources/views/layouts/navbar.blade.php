...
<nav class="main-header navbar navbar-expand navbar-dark	">
    ...
    <div>
        ...
        <span style="font-weight: 400; font-size: 16.8194px; line-height: 23px;color: #FFFFFF;">{{$greet}}, good
            luck! </span>
    </div>
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <a class="user-panel mt-3 pb-3 mb-3 d-flex nav-link" data-toggle="dropdown" href="#">
                <div class="image">
                    <img src="{{ asset('viewly_assets/dist/img/user2-160x160.jpg') }}"
            ...
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                ...
                <a href="#" class="dropdown-item text-center" class="dropdown-item"
                    href="{{ route('logout') }}"
